...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            @if (Route::has('login'))
                @auth
                    <a action="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        Çıkış Yap
                    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">KULLANICILAR</li>
          ...
          <div class="col-md-12">
              <div class="card card-info">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                          <label for="inputStatus">Aktiflik</label>
                          <select name="aktiflik" id="inputStatus" class="form-control custom-select">
                              <option @if($user->aktiflik == 'Select one') selected @endif>Select one</option>
                              <option @if($user->aktiflik == 'Aktif') selected @endif>Aktif</option>
                              <option @if($user->aktiflik == 'Pasif') selected @endif>Pasif</option>
                          </select>
                      </div>

                      <div class="form-group">
                          <label for="inputClientCompany">Email</label>
                          <input name="email" type="text" id="inputClientCompany" class="form-control" value="{{ $user->email }}">
                      </div>

                      <div class="form-group">
                          <label for="inputProjectLeader">Kullanıcı Tipi</label>
                          <input type="text" id="inputProjectLeader" class="form-control" value="{{ $user->user_type == 0 ? 'admin' : 'normal' }}" disabled>
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="card card-outline card-info">
                                          ...
                                          <div class="card-body">
                                              <textarea name="address" class="form-control" id="summernote" value="{{$user->address}}">{{$user->address}}</textarea>
                                          </div>
                                      </div>
                                  </div>
                                  <!-- /.col-->
  ...
  <script src="../../AdminLte/plugins/codemirror/mode/javascript/javascript.js"></script>
...
$(document).ready(function() {
    ...
    $('#save').on('click', function(event) {
        ...
        var content = $('#summernote').summernote('code'); // veya getHTML kullanarak içeriği al

        var cleanedContent = stripHtmlTags(content); // HTML taglerini kaldır

        $('#summernote').val(cleanedContent); // textarea içeriğini güncelle

        // Formu submit et
        $('form').submit();
    });

    // HTML taglerini kaldıran fonksiyon
